...
<head>
    ...
    <script>
        function calculate() {
            ...
            if (LA != "" && LIR != "" && MP != "" && LIR >= .01 && LIR <= .54 && LA >= 0 && LA <= 999999999 && MP >= 0 && MP <= 999999999) {
                ...
                document.getElementById("output").innerHTML += "<br>Interest On Top of Loan To Be Paid: " + IAmount.toFixed(2);
            } else {
