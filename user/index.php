  ...
  <script>
    window.onload = function () {
      ...
      if (m == 1) {
        ...
        $.when(setTimeout(updateJuly(), 100)).then(setTimeout(updateAugust(), 200)).then(setTimeout(updateSeptember(), 300)).then(setTimeout(updateOctober(), 400)).then(setTimeout(updateNovember(), 500)).then(setTimeout(updateDecember(), 600)).then(setTimeout(updateJanuary(), 700)).then(setTimeout(updateFebruary(), 800)).then(setTimeout(updateMarch(), 900)).then(setTimeout(updateApril(), 1000)).then(setTimeout(updateMay(), 1100)).then(setTimeout(updateJune(), 1200));
      } else if (m == 8) {
