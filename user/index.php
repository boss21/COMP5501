  ...
  <script>
    window.onload = function () {
      ...
      if (m == 1) {
        ...
        $.when(setTimeout(updateJuly(), 5000)).then(setTimeout(updateAugust(), 5000)).then(setTimeout(updateSeptember(), 5000)).then(setTimeout(updateOctober(), 5000)).then(setTimeout(updateNovember(), 5000)).then(setTimeout(updateDecember(), 5000)).then(setTimeout(updateJanuary(), 5000)).then(setTimeout(updateFebruary(), 5000)).then(setTimeout(updateMarch(), 5000)).then(setTimeout(updateApril(), 5000)).then(setTimeout(updateMay(), 5000)).then(setTimeout(updateJune(), 5000));
      } else if (m == 8) {
