...
$sql = "SELECT day, itemName, itemAmount FROM june WHERE email = '$email' ORDER BY day ASC, itemAmount DESC";
$result = mysqli_query($link, $sql);
...
if (mysqli_num_rows($result) > 0){
    ...
    echo "<hr>";
    if ($currDay >= 1 && $currDay <= 7 || date("m") != 6){
        //WEEK1
        echo "<b><u>WEEK 1</u></b>";
        echo "<br>";
        $week1 = $juneBal;
    ...
    if ($currDay >= 1 && $currDay <= 14 || date("m") != 6){
        //WEEK2
        echo "<b><u>WEEK 2</u></b>";
        echo "<br>";
        if ($week1 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 21 || date("m") != 6){
        //WEEK3
        echo "<b><u>WEEK 3</u></b>";
        echo "<br>";
        if ($week2 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 28 || date("m") != 6){
        //WEEK4
        echo "<b><u>WEEK 4</u></b>";
        echo "<br>";
        if ($week3 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 30 || date("m") != 6){
        //WEEK5
        echo "<b><u>WEEK 5</u></b>";
        echo "<br>";
        if ($week4 != ""){
    ...
    // Attempt select query execution
    $sql = "UPDATE users SET juneBalance = '$juneBal' WHERE email = '$email'";
    mysqli_query($link, $sql);
}
