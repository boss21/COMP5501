...
$sql = "DELETE FROM may WHERE email = '$email' AND timestamp < '$currTimestamp'";
...
if (mysqli_num_rows($result) > 0){
    ...
    //grab data here
    if ((date("m") != 5 && $row['aprilBalance'] != "") || ($hasEntries == false && $row['aprilBalance'] != "")){
    ...
    echo "<hr>";
    if ($currDay >= 1 && $currDay <= 7 || date("m") != 5){
        //WEEK1
        echo "<b><u>WEEK 1</u></b>";
        echo "<br>";
        $week1 = $mayBal;
            ...
            for ($j = 0; $j < sizeof($itemAmounts[$i]); $j++){
                if ($itemAmounts[$i][$j] != ""){
                    if ($itemAmounts[$i][$j] < 0){
                        echo $itemAmounts[$i][$j]." ".$itemNames[$i][$j]." 5/".($i+1);
                    }else{
                        echo "+".$itemAmounts[$i][$j]." ".$itemNames[$i][$j]." 5/".($i+1);
                    }
                    echo "<br>";
    ...
    if ($currDay >= 1 && $currDay <= 14 || date("m") != 5){
        //WEEK2
        echo "<b><u>WEEK 2</u></b>";
        echo "<br>";
        if ($week1 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 21 || date("m") != 5){
        //WEEK3
        echo "<b><u>WEEK 3</u></b>";
        echo "<br>";
        if ($week2 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 28 || date("m") != 5){
        //WEEK4
        echo "<b><u>WEEK 4</u></b>";
        echo "<br>";
        if ($week3 != ""){
    ...
    if ($currDay >= 1 && $currDay <= 31 || date("m") != 5){
        //WEEK5
        echo "<b><u>WEEK 5</u></b>";
        echo "<br>";
        if ($week4 != ""){
    ...
    // Attempt select query execution
    $sql = "UPDATE users SET mayBalance = '$week5' WHERE email = '$email'";
